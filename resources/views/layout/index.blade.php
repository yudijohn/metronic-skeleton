...
<html lang="en">
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_app_body" data-kt-app-layout="{{ ( isset( $_page_sidebar_option ) && in_array( $_page_sidebar_option, [ 'dark', 'light' ] ) ) ? $_page_sidebar_option : config( 'system.theme.sidebar', 'light' ) }}-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" data-kt-app-toolbar-fixed="{{ ( isset( $_toolbar_transparent ) && ! $_toolbar_transparent ) ? 'true' : 'false' }}" class="app-default">
