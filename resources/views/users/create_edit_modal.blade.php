...
<div class="modal fade" id="ym_modal_create_edit_user" tabindex="-1" aria-hidden="true">
	<!--begin::Modal dialog-->
	<div class="modal-dialog modal-dialog-centered mw-650px">
		...
		<div class="modal-content">
			...
			<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
				<!--begin::Form-->
				<form id="ym_modal_create_edit_user_form" class="form">
					<!--begin::Scroll-->
					<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
						...
						<div class="fv-row mb-7">
							...
							<!--end::Label-->
							<!--begin::Input-->
							<input type="password" name="password" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="User password" />
							<!--end::Input-->
						</div>
						<!--end::Input group-->
						<!--begin::Input group-->
...
@push( 'scripts' )
	<script type="text/javascript">
		"use strict";
		var YMCreateUser = function() {
		    const t = document.getElementById( 'ym_modal_create_edit_user' ),
		        e = t.querySelector( '#ym_modal_create_edit_user_form' ),
		                	...
		                	o.validate().then( function( t ) {
		                		if( "Valid" == t ) {
		                			...
		                			$.ajax( {
		                				...
		                				method: 'post',
		                				data: $( '#ym_modal_create_edit_user_form' ).serialize(),
		                				success: function( response ) {
				                            i.removeAttribute( "data-kt-indicator" );
				                            i.disabled = !1;
				                            e.reset();
		                					if( response.code == 201 ) {
									        	YMCreateUser.storeUserCallback( response.data );
					                            Swal.fire( {
